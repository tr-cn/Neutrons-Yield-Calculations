close all; clc; clear;
open('Electrons.fig');pause (1);ax_e = gca;  e_fig = gcf;
ax_e.FontSize = 46;
ax_e.YLabel.FontSize = 56;
ax_e.XLabel.FontSize = 56;
ax_e.Layer = "top";

open('Neutrons.fig');pause (1);ax_n = gca; n_fig = gcf;
ax_n.FontSize = 46;
...
saveas(e_fig,'Electrons_mod.fig')
saveas(e_fig,'Electrons_mod.emf')
saveas(n_fig,'Neutrons_mod.fig')
saveas(n_fig,'Neutrons_mod.emf')
